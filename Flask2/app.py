...
todays_datetime = datetime.today()-timedelta(30)
app=Flask(__name__)
...
def EditView():
    ...
    return render_template('sucess.html',Students=Students)
...
def Analytics():
    ...
    Students = FormResults.query.filter(FormResults.Date >= todays_datetime).all()
    studentToHours=dict()
    ...
    return render_template("Analytics.html",data=[CSA_Community,CSA_Service,CSA_Achievement])

    
@app.route('/Analytics/data',methods=['POST','GET'])
def data_an():
    pass
